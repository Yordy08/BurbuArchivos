...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container py-5" }, _attrs))}><div class="text-center mb-5"><p class="text-muted"> Gestión de usuarios y estadísticas del sistema </p></div>`);
      if (!isAdmin.value) {
        _push(`<div class="alert alert-danger text-center"> ❌ No tienes permisos para acceder a esta sección </div>`);
      } else {
        _push(`<div>`);
...
//# sourceMappingURL=adminpro-BzBrF1zo.js.map
