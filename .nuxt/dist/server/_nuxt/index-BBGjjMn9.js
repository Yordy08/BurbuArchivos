...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mt-5" }, _attrs))} data-v-e4e1caae><h1 data-v-e4e1caae>Panel de Administración</h1><p data-v-e4e1caae>Gestión del sistema</p></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e4e1caae"]]);
export {
  index as default
};
//# sourceMappingURL=index-BBGjjMn9.js.map
