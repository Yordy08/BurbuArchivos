...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mt-5" }, _attrs))} data-v-eeec6003><h1 data-v-eeec6003>Gestión de Usuarios</h1><p data-v-eeec6003>Administrar usuarios del sistema</p></div>`);
    };
  }
};
...
const users = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eeec6003"]]);
export {
  users as default
};
//# sourceMappingURL=users-Cyn0MNZb.js.map
